...
pub const VK_ERROR_OUT_OF_HOST_MEMORY: vk::Result = vk::Result::ERROR_OUT_OF_HOST_MEMORY;
pub const VK_ERROR_OUT_OF_DEVICE_MEMORY: vk::Result = vk::Result::ERROR_OUT_OF_DEVICE_MEMORY;
pub const VK_ERROR_INITIALIZATION_FAILED: vk::Result = vk::Result::ERROR_INITIALIZATION_FAILED;
pub const VK_ERROR_DEVICE_LOST: vk::Result = vk::Result::ERROR_DEVICE_LOST;
pub const VK_ERROR_MEMORY_MAP_FAILED: vk::Result = vk::Result::ERROR_MEMORY_MAP_FAILED;
pub const VK_ERROR_LAYER_NOT_PRESENT: vk::Result = vk::Result::ERROR_LAYER_NOT_PRESENT;
pub const VK_ERROR_EXTENSION_NOT_PRESENT: vk::Result = vk::Result::ERROR_EXTENSION_NOT_PRESENT;
pub const VK_ERROR_FEATURE_NOT_PRESENT: vk::Result = vk::Result::ERROR_FEATURE_NOT_PRESENT;
pub const VK_ERROR_INCOMPATIBLE_DRIVER: vk::Result = vk::Result::ERROR_INCOMPATIBLE_DRIVER;
pub const VK_ERROR_TOO_MANY_OBJECTS: vk::Result = vk::Result::ERROR_TOO_MANY_OBJECTS;
pub const VK_ERROR_FORMAT_NOT_SUPPORTED: vk::Result = vk::Result::ERROR_FORMAT_NOT_SUPPORTED;
pub const VK_ERROR_FRAGMENTED_POOL: vk::Result = vk::Result::ERROR_FRAGMENTED_POOL;
pub const VK_ERROR_UNKNOWN: vk::Result = vk::Result::ERROR_UNKNOWN;
// Provided by VK_VERSION_1_1
pub const VK_ERROR_OUT_OF_POOL_MEMORY: vk::Result = vk::Result::ERROR_OUT_OF_POOL_MEMORY;
// Provided by VK_VERSION_1_1
pub const VK_ERROR_INVALID_EXTERNAL_HANDLE: vk::Result = vk::Result::ERROR_INVALID_EXTERNAL_HANDLE;
// Provided by VK_VERSION_1_2
pub const VK_ERROR_FRAGMENTATION: vk::Result = vk::Result::ERROR_FRAGMENTATION;
// Provided by VK_VERSION_1_2
pub const VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS: vk::Result = vk::Result::ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS;
// Provided by VK_VERSION_1_3
pub const VK_PIPELINE_COMPILE_REQUIRED: vk::Result = vk::Result::PIPELINE_COMPILE_REQUIRED;
// Provided by VK_KHR_surface
pub const VK_ERROR_SURFACE_LOST_KHR: vk::Result = vk::Result::ERROR_SURFACE_LOST_KHR;
// Provided by VK_KHR_surface
pub const VK_ERROR_NATIVE_WINDOW_IN_USE_KHR: vk::Result = vk::Result::ERROR_NATIVE_WINDOW_IN_USE_KHR;
// Provided by VK_KHR_swapchain
pub const VK_SUBOPTIMAL_KHR: vk::Result = vk::Result::SUBOPTIMAL_KHR;
// Provided by VK_KHR_swapchain
pub const VK_ERROR_OUT_OF_DATE_KHR: vk::Result = vk::Result::ERROR_OUT_OF_DATE_KHR;
// Provided by VK_KHR_display_swapchain
pub const VK_ERROR_INCOMPATIBLE_DISPLAY_KHR: vk::Result = vk::Result::ERROR_INCOMPATIBLE_DISPLAY_KHR;
// Provided by VK_EXT_debug_report
pub const VK_ERROR_VALIDATION_FAILED_EXT: vk::Result = vk::Result::ERROR_VALIDATION_FAILED_EXT;
// Provided by VK_NV_glsl_shader
pub const VK_ERROR_INVALID_SHADER_NV: vk::Result = vk::Result::ERROR_INVALID_SHADER_NV;
// Provided by VK_KHR_video_queue
pub const VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR: vk::Result = vk::Result::ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR;
// Provided by VK_KHR_video_queue
pub const VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR: vk::Result = vk::Result::ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR;
// Provided by VK_KHR_video_queue
pub const VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR: vk::Result = vk::Result::ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR;
// Provided by VK_KHR_video_queue
pub const VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR: vk::Result = vk::Result::ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR;
// Provided by VK_KHR_video_queue
pub const VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR: vk::Result = vk::Result::ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR;
// Provided by VK_KHR_video_queue
pub const VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR: vk::Result = vk::Result::ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR;
// Provided by VK_EXT_image_drm_format_modifier
pub const VK_ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT: vk::Result = vk::Result::ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT;
// Provided by VK_KHR_global_priority
pub const VK_ERROR_NOT_PERMITTED_KHR: vk::Result = vk::Result::ERROR_NOT_PERMITTED_KHR;
// Provided by VK_EXT_full_screen_exclusive
pub const VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT: vk::Result = vk::Result::ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT;
...
pub const VK_ERROR_COMPRESSION_EXHAUSTED_EXT: vk::Result = vk::Result::ERROR_COMPRESSION_EXHAUSTED_EXT;
